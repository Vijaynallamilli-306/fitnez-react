...
export default function HomeSection() {
  return (
    <section
      className="w-full bg-cover bg-center relative pt-4 sm:pt-4"
    ...
    >
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center text-white px-4 sm:px-6 min-h-[58vh]">
        <h1
